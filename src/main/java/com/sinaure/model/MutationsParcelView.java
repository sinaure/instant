 ...
 */
@Entity
@Table(name="mutations_parcel_view")
public class MutationsParcelView {
	...
	@Column(name="geometry_parcel")
	private String geometryParcel;

	@Column(name="geometry_parcel_mutation")
	private String geometryParcelMutation;
	...
	public String getGeometryParcel() {
		return this.geometryParcel;
	}

	public void setGeometryParcel(String geometryParcel) {
		this.geometryParcel = geometryParcel;
	}
	public String getGeometryParcelMutation() {
		return this.geometryParcelMutation;
	}

	public void setGeometryParcelMutation(String geometryParcelMutation) {
		this.geometryParcelMutation = geometryParcelMutation;
	}
